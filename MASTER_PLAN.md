...
> 最后更新: 2026-03-08 04:15 (循环 #60 Phase 2)

## 当前阶段: ★★ P5b@3000 红线 3/5 达标! bg_FA=0.217 突破+off_th=0.200 达标+car_P=0.107 历史新高; 10 类扩展已 commit; iter 3340/6000
...
| 指标 | @500 | @1000 | @1500 | @2000 | @2500 | **@3000** | 红线 |
|------|------|-------|-------|-------|-------|-----------|------|
| car_R | 0.856 | 0.760 | 0.924 | 0.856 | 0.831 | 0.835 | — |
| car_P | 0.080 | 0.089 | 0.091 | 0.094 | 0.094 | **0.107** | — |
| truck_R | 0.153 | **0.568** | 0.390 | 0.340 | 0.287 | 0.205 | ≥0.08 ✅ |
| truck_P | 0.039 | 0.061 | 0.030 | 0.035 | 0.045 | 0.035 | — |
| bus_R | 0.014 | 0.368 | 0.000 | 0.085 | **0.470** | 0.051 | — |
| bus_P | 0.030 | 0.057 | 0.000 | 0.071 | 0.067 | 0.026 | — |
| trailer_R | 0.000 | 0.000 | 0.000 | 0.028 | **0.444** | 0.389 | — |
| trailer_P | 0.000 | 0.000 | 0.000 | 0.003 | 0.010 | **0.037** | — |
| bg_FA | 0.235 | 0.302 | 0.333 | 0.282 | 0.283 | **0.217** | ≤0.25 ✅ |
| off_cx | 0.068 | **0.049** | 0.064 | 0.055 | 0.073 | 0.059 | ≤0.05 ✗ |
| off_cy | **0.085** | 0.122 | 0.144 | 0.113 | 0.112 | 0.112 | ≤0.10 ✗ |
| off_th | 0.210 | **0.168** | 0.203 | 0.208 | 0.212 | **0.200** | ≤0.20 ✅ |

> LR decay @2500: 2.5e-06→2.5e-07 | 第二次 decay @4000: 2.5e-07→2.5e-08

**@3000 LR Decay 效果分析**:
1. **bg_FA=0.217 首次突破红线!** 从 0.283→0.217, ↓23%
2. **car_P=0.107 历史新高!** 超 P5 全程最优 (0.093) +15%
3. **off_th=0.200 精确达标!** 从 0.212→0.200
4. **trailer_P=0.037 精度飞跃!** +270%
5. **bus 振荡未解**: 0.470→0.051, ~1000 iter 周期持续 (BUG-20: 数据量不足)
6. **off_cx=0.059, off_cy=0.112 未达标**: 差 0.009 和 0.012
...
## 红线监控
| 指标 | 红线 | @1000 | @2000 | @2500 | **@3000** | 趋势 | 状态 |
|------|------|-------|-------|-------|-----------|------|------|
| truck_R | ≥ 0.08 | 0.568✅ | 0.340✅ | 0.287✅ | 0.205✅ | ↓ 缓降但稳定达标 | ✅ |
| bg_FA | ≤ 0.25 | 0.302❌ | 0.282❌ | 0.283❌ | **0.217✅** | **↓ 突破红线!** | ✅ |
| offset_th | ≤ 0.20 | 0.168✅ | 0.208❌ | 0.212❌ | **0.200✅** | **↓ 精确达标!** | ✅ |
| offset_cx | ≤ 0.05 | 0.049✅ | 0.055❌ | 0.073❌ | 0.059❌ | ↓ 改善中, 差0.009 | ❌ |
| offset_cy | ≤ 0.10 | 0.122❌ | 0.113❌ | 0.112❌ | 0.112❌ | ~ 稳定, 差0.012 | ❌ |

**红线达标 3/5** (truck_R, bg_FA, off_th) — 从 @2500 的 1/5 显著回升! LR decay 效果验证成功。
