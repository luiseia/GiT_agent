...
> 最后更新: 2026-03-08 15:46 (循环 #85 Phase 1)

## CEO 战略转向 (2026-03-08)
> **不再以 Recall/Precision 为最高目标，不再高度预警红线。**
> **目标: 设计出在完整 nuScenes 上性能优秀的代码。mini 数据集仅用于 debug。**

## 当前阶段: ★★★ P6 COMPLETED car_P=0.129 | P2@1500=0.112 超 P6@2000! | 等 P2@2000 (~15:55) 最终决策 | 3 GPU 空闲
...
| @1500 | 0.106 | **0.112** | **0.279** | **★★ 超 P6@1500 +5.7%! 超 P6@2000(0.110)!** bg_FA 大幅改善 -15% |
| @2000 | 0.110 | ? (~15:55) | ? | **★★★ P2>0.110 → full nuScenes 用 2048+GELU!** |
...
| @2000 | **0.111** | 0.094 (DDP) | 0.110 | ? (~15:55) |
| @3000 | — | **0.116 ✅** | 0.106 | — |
| @3500 | — | — | **0.121 ✅** | — |
| @4000 | — | — | **0.1263 ✅✅** | — |
| @5000⚠️DDP | — | — | 0.128 (DDP) | — |
