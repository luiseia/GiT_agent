...
> 最后更新: 2026-03-08 05:15 (循环 #62 Phase 2)

## CEO 战略转向 (2026-03-08)
> **不再以 Recall/Precision 为最高目标，不再高度预警红线。**
> **目标: 设计出在完整 nuScenes 上性能优秀的代码。mini 数据集仅用于 debug。**

## 当前阶段: P5b@4000 第二次 LR decay 确认, off_th=0.196+bg_FA=0.211; iter 4360/6000 收尾中
...
- **LR**: **2.5e-08** (第二次 decay @4000 已确认 ✅, 模型基本冻结)
- **ETA 完成**: ~06:26
- **下次 val**: @4500 (~05:30)
- **三项修复验证**:
...
|------|------|-------|-------|-------|-------|-------|-------|-----------|
| car_R | 0.856 | 0.760 | 0.924 | 0.856 | 0.831 | 0.835 | 0.819 | 0.792 |
| car_P | 0.080 | 0.089 | 0.091 | 0.094 | 0.094 | 0.107 | **0.108** | 0.105 |
| truck_R | 0.153 | **0.568** | 0.390 | 0.340 | 0.287 | 0.205 | 0.234 | 0.229 |
| bus_R | 0.014 | 0.368 | 0.000 | 0.085 | **0.470** | 0.051 | 0.053 | 0.060 |
| trailer_R | 0.000 | 0.000 | 0.000 | 0.028 | **0.444** | 0.389 | 0.417 | 0.417 |
| trailer_P | 0.000 | 0.000 | 0.000 | 0.003 | 0.010 | 0.037 | 0.036 | 0.033 |
| bg_FA | 0.235 | 0.302 | 0.333 | 0.282 | 0.283 | 0.217 | 0.214 | **0.211** |
| off_cx | 0.068 | **0.049** | 0.064 | 0.055 | 0.073 | 0.059 | 0.060 | 0.059 |
| off_cy | **0.085** | 0.122 | 0.144 | 0.113 | 0.112 | 0.112 | 0.116 | 0.132 |
| off_th | 0.210 | **0.168** | 0.203 | 0.208 | 0.212 | 0.200 | 0.206 | **0.196** |
