...
- **多类爆发**: bus_R=0.287 (0→), ped_P=0.024 (48x!), cone_R=0.160 (新), truck_R=0.138 (+134%)
- **bg_FA=0.331 恶化**: 0.199→0.331 (+66%), 模型从保守→激进预测, 多类学习早期典型
- **offset 回归恶化**: off_w/off_h 大幅恶化 (新类几何不同), off_cy=0.082 改善 ✅
