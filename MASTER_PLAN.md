...
## 当前阶段: P5b 即将完成; VERDICT_P6_ARCHITECTURE 处理; 诊断实验规划
...
### P5b 训练状态 — COMPLETING (plan_i_p5b_3fixes)
- **启动时间**: 2026-03-07 23:56
- **进度**: iter 5910 / 6000 (98.5%), **模型完全冻结** (@5000: 10/14 指标零变化)
- **GPU**: 0 + 2
- **ETA 完成**: ~06:36 (即将完成)
...
| 指标 | @500 | @1000 | @1500 | @2000 | @2500 | @3000 | @3500 | @4000 | @4500 | @5000 | **@5500** |
|------|------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-----------|
| car_R | 0.856 | 0.760 | 0.924 | 0.856 | 0.831 | 0.835 | 0.819 | 0.792 | 0.788 | 0.788 | 0.777 |
| car_P | 0.080 | 0.089 | 0.091 | 0.094 | 0.094 | 0.107 | **0.108** | 0.105 | 0.105 | 0.105 | 0.104 |
| truck_R | 0.153 | **0.568** | 0.390 | 0.340 | 0.287 | 0.205 | 0.234 | 0.229 | 0.238 | 0.239 | 0.243 |
| bus_R | 0.014 | 0.368 | 0.000 | 0.085 | **0.470** | 0.051 | 0.053 | 0.060 | 0.059 | 0.059 | 0.058 |
| trailer_R | 0.000 | 0.000 | 0.000 | 0.028 | **0.444** | 0.389 | 0.417 | 0.417 | 0.417 | 0.417 | 0.417 |
| trailer_P | 0.000 | 0.000 | 0.000 | 0.003 | 0.010 | 0.037 | 0.036 | 0.033 | 0.032 | 0.034 | 0.028 |
| bg_FA | 0.235 | 0.302 | 0.333 | 0.282 | 0.283 | 0.217 | 0.214 | 0.211 | 0.210 | 0.210 | **0.209** |
| off_cx | 0.068 | **0.049** | 0.064 | 0.055 | 0.073 | 0.059 | 0.060 | 0.059 | 0.059 | 0.059 | 0.058 |
| off_cy | **0.085** | 0.122 | 0.144 | 0.113 | 0.112 | 0.112 | 0.116 | 0.132 | 0.130 | 0.132 | 0.134 |
| off_th | 0.210 | **0.168** | 0.203 | 0.208 | 0.212 | 0.200 | 0.206 | **0.196** | 0.202 | 0.201 | 0.202 |

> LR decay: @2500 (2.5e-06→2.5e-07) | @4000 (2.5e-07→2.5e-08) ✅ 两次均已确认

**P5b 阶段总结 (截至 @5500, CEO 新方向下)**:
- mini 数据集仅用于验证代码正确性和基本训练能力, 指标波动是数据量天花板
- **代码验证成功**: 双层投影+sqrt 权重+LR milestones 三项修复均按设计运行
- **双层投影已触顶**: @3000-5500 car_P 标准差 0.0015, 模型完全冻结
...
| **ORCH_015** | **诊断实验 (单类 car + 宽中间层)** | **PENDING** |

## 指标参考 (CEO: 红线降级, mini 仅 debug)
| 指标 | 参考线 | @3000 | @4000 | @4500 | @5000 | **@5500** | 备注 |
|------|--------|-------|-------|-------|-------|-----------|------|
| truck_R | ≥ 0.08 | 0.205 | 0.229 | 0.238 | 0.239 | 0.243 | 微升 |
| bg_FA | ≤ 0.25 | 0.217 | 0.211 | 0.210 | 0.210 | **0.209** | 持续新低 |
| off_th | ≤ 0.20 | 0.200 | 0.196 | 0.202 | 0.201 | 0.202 | 冻结边缘 |
| off_cx | ≤ 0.05 | 0.059 | 0.059 | 0.059 | 0.059 | 0.058 | 冻结 |
| off_cy | ≤ 0.10 | 0.112 | 0.132 | 0.130 | 0.132 | 0.134 | 冻结偏高 |
