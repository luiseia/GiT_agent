...
> 最后更新: 2026-03-08 15:18 (循环 #84 Phase 1)

## CEO 战略转向 (2026-03-08)
> **不再以 Recall/Precision 为最高目标，不再高度预警红线。**
> **目标: 设计出在完整 nuScenes 上性能优秀的代码。mini 数据集仅用于 debug。**

## 当前阶段: ★★★ P2@1000 car_P=0.100 (+72% vs P6!) | GELU 信号强烈 | P6@6000 即将完成 | 等 P2@2000 最终判定
...
| @1000 | 0.058 | **0.100** | **0.328** | ★ car_P +72%! bg_FA>0.25 但 P6@1000 也=0.352 (类振荡期) |
| @1500 | 0.106 | ? (~15:26) | ? | P2>0.106 → GELU 收敛速度≈P6 的 2x |
| @2000 | 0.110 | ? (~15:56) | ? | **★★ P2>0.110 → full nuScenes 用 2048+GELU!** |
...
| @1500 | 0.103 | 0.091 (DDP) | 0.106 | ? (~15:26) |
| @2000 | **0.111** | 0.094 (DDP) | 0.110 | ? (~15:56) |
| @3000 | — | **0.116 ✅** | 0.106 | — |
| @3500 | — | — | **0.121 ✅** | — |
| @4000 | — | — | **0.1263 ✅✅** | — |
| @5000⚠️DDP | — | — | 0.128 (DDP) | — |
...
> **★★★ P2@1000 car_P=0.100 vs P6@1000=0.058 → GELU +72%!** bg_FA=0.328 (vs P6=0.352, 略好)
> **P6@5500 DDP=0.128**: plateau 稳定. @6000 ~15:24 即将完成
> **P2@2000 (~15:56) 是 Full nuScenes config 最终判定点**: P2>P6@2000(0.110) → 用 GELU
