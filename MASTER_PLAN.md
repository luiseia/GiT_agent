...
### 训练状态
- **Resume from ORCH_034@4000**, 当前 iter 7550 (post-@6000 val, 平稳巡航向 @8000)
...
| **当前** | 03/13 02:05 | ORCH_035 @8000 | ⭐ val 进行中 140/753, 结果 ~02:52 | VAL_RUNNING |
...
│   ├─ 检查 IoF=0.30 是否太严格
│   └─ 检查 vis+cell_count 组合是否误杀
│
└─ off_th > 0.25 → z-fix 角度适应缓慢, 可能需要 warmup 角度 loss
```
