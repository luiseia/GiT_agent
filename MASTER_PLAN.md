...
| **ORCH_015** | **诊断实验 (单类 car + 宽中间层)** | **执行中 — Plan K/L iter ~280/2000, GPU 0,2** |
| **ORCH_016** | **DINOv3 在线提取 + unfreeze** | **DELIVERED — Plan M/N 待启动, GPU 1,3** |
