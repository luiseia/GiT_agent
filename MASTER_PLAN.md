...
> 最后更新: 2026-03-08 01:15 (循环 #57 Phase 1)

## 当前阶段: ★ P5b@1000 突破! 三类同时活跃, bus 超 P5 最优, iter 1310/6000
...
### ★★ P5b@1000 — 三类同时活跃! bus 复活! offset_cx 首破红线! ★★

| 指标 | P5b@500 | P5b@1000 | P5@1000 | P5 全程最优 | 趋势 |
|------|---------|----------|---------|------------|------|
| car_R | 0.856 | 0.760 | 0.952 | 0.955 | ↓ car 让出配额 |
| car_P | 0.080 | **0.089** | 0.052 | 0.093 | ↑ 接近 P5 最优 |
| truck_R | 0.153 | **0.568** | 0.000 | 0.679 | ↑↑ 3.7x 爆发 |
| truck_P | 0.039 | **0.061** | 0.000 | 0.175 | ↑ |
| bus_R | 0.014 | **0.368** | 0.000 | **0.315** | ↑↑ **超越 P5 全程最优!** |
| bus_P | — | **0.057** | 0.000 | 0.129 | ↑ |
| trailer_R | 0.000 | 0.000 | 0.056 | 0.750 | — 样本少, 需更多 iter |
| bg_FA | 0.235 | 0.302 | 0.354 | 0.160 | ↑ 暂超红线, 优于 P5 同期 |
| offset_cx | 0.068 | **0.049** | 0.059 | 0.051 | ↓ **首破 0.05 红线!** |
| offset_cy | 0.085 | 0.122 | 0.156 | 0.091 | ↑ 新类别效应 |
| offset_th | 0.210 | **0.168** | 0.225 | 0.142 | ↓ 持续改善 |

**突破总结**:
1. **三类同时活跃 — 历史首次!** P5b@1000 仅用 1000 iter 就接近 P5@4000 的类别均衡度
2. **bus_R=0.368 超越 P5 全程最优 (0.315)** — P5 整个 6000 iter bus 最高仅 0.315, P5b 1000 iter 即超越
3. **offset_cx=0.049 首破红线** — 所有实验的第一次
4. **sqrt 权重强力验证**: car 让出预测配额, 被 truck/bus 吸收, 正是设计意图
...
| bg_FA | ≤ 0.25 | 0.235 ✅ | 0.302 ❌ | ↑ | 暂超, 预期 LR decay 后下降 |
| offset_th | ≤ 0.20 | 0.210 ❌ | **0.168** ✅ | ↓ | **达标!** |
| offset_cx | ≤ 0.05 | 0.068 ❌ | **0.049** ✅ | ↓ | **历史首次达标!** |
| offset_cy | ≤ 0.10 | 0.085 ✅ | 0.122 ❌ | ↑ | 新类别引入暂时劣化 |
