...
## Cycle #186 | 2026-03-09 02:23 | iter 4450/40000 (11.1%)
- Loss: 3.79 (cls=2.06, reg=1.73), grad_norm=20.3
- 速度: ~6.28-6.50 s/iter, 显存: 28849 MB/GPU
- GPU: 4卡 100%, 磁盘: 322G 可用, 进程: 22
- 状态: 巡航中, 无异常
- 下一 val: @6000 (~3/9 05:30)

---

## Cycle #187 | 2026-03-09 02:52 | iter 4720/40000 (11.8%)
- Loss: 4.70 (cls=2.66, reg=2.04), grad_norm=29.2
- 速度: ~6.28-6.52 s/iter, 显存: 28849 MB/GPU
- GPU: 4卡 100%, 磁盘: 322G 可用, 进程: 22
- 状态: 巡航中, 无异常
- 下一 val: @6000 (~3/9 05:30)
...
## Cycle #188 | 2026-03-09 03:20 | iter 4920/40000 (12.3%) ⚠️⚠️
- **🚨 GPU 1 被外部进程 PID 908307 抢占 11094 MB!**
- GPU 1 总显存 47852/49140 MB (97.4%), OOM 风险!
- 训练速度退化: 交替 6.2s/28s, 平均 ~17 s/iter (2.7x 减速)
- 减速从 iter ~4840 开始
- Loss 正常, 训练未崩溃, 但速度严重受影响
- **需要用户处理: kill 908307 或迁移**

---

## Cycle #189 | 2026-03-09 03:49 | iter 5080/40000 (12.7%) ⚠️
- GPU 1 外部进程 PID 908307 仍在运行, 未解决
- 速度: 交替 6.2s / 21-28s, 训练持续减速
- Loss 正常 (4.64), 训练未崩溃
- 磁盘: 320G 可用
- **仍需用户处理 kill 908307**
...
## Cycle #190 | 2026-03-09 04:18 | iter 5230/40000 (13.1%) ⚠️
- GPU 1 PID 908307 仍在, 已持续 ~1.5h
- 速度: 恒定交替 6.2s/28.4s
- ETA 膨胀至 2d 16:44 (正常 ~2d 13:00)
- Loss 正常 (2.60), 训练未崩溃
- **仍需用户 kill 908307**

---

## Cycle #191 | 2026-03-09 04:48 | iter 5390/40000 (13.5%) ⚠️
- GPU 1 PID 908307 仍在, 已持续 ~2h
- 速度: 交替 6.2s/28-30s, ETA 膨胀 +5h
- Loss 正常, 磁盘: 318G
- **仍需用户 kill 908307**

---

## Cycle #192 | 2026-03-09 05:16 | iter 5540/40000 (13.9%) ⚠️
- GPU 1 PID 908307 持续 ~3h, ETA 膨胀 +6h
- 速度: 交替 6.2s/22-29s
- Loss 正常, 磁盘: 316G
- @6000 val 预计延至 ~07:45
- **仍需用户 kill 908307**
...
## Cycle #193 | 2026-03-09 05:45 | iter 5690/40000 (14.2%) ⚠️
- GPU 1 PID 908307 持续 ~3.5h, ETA +7.5h
- 速度: 交替 6.2s/28s, Loss 正常
- 磁盘: 316G, @6000 val ~1.5h 后
- **仍需用户 kill 908307**

---

## Cycle #194 | 2026-03-09 06:14 | iter 5850/40000 (14.6%) ⚠️
- GPU 1 PID 908307 持续 ~4h, ETA +8.5h
- Loss 正常, 磁盘: 314G
...
## Cycle #196 | 2026-03-09 07:13 | @6000 val 390/753 (52%)
- Val 稳定 ~4.6 s/batch, ETA ~07:41
- GPU 1 PID 908307 ~5h, val 未 OOM
- 磁盘: 298G, 进程: 42
- **下一轮捕获 val 结果**

---

## Cycle #197 | 2026-03-09 07:43 | @6000 val 750/753 metric 聚合中
- ✅ **GPU 1 恢复正常! PID 908307 已消失** (持续了 ~5h)
- GPU 1: 36782 MB, 训练速度将恢复 ~6.3 s/iter
- Val 750/753, DDP metric 聚合中 (正常需几分钟)
- 磁盘: 296G
- **下一轮捕获 @6000 val 结果**

---

## Cycle #198 | 2026-03-09 08:11 | ⭐ @6000 Val 结果! + GPU 1 恢复!
**@6000 DDP Val (iter 6000/40000, 15%):**
| 指标 | @6000 | @4000 | @2000 | 趋势 |
|------|-------|-------|-------|------|
| car_P | 0.0898 | 0.0783 | 0.0789 | ✅ +15% 突破! |
| car_R | 0.455 | 0.419 | 0.627 | 回升 |
| truck_P | 0.019 | 0.057 | 0 | ⚠️ P↓ R↑ |
| truck_R | 0.138 | 0.059 | 0 | ✅ +134% |
| bus_R | 0.287 | 0.0003 | 0 | ✅✅ 爆发! |
| ped_P | 0.024 | 0.0005 | 0.001 | ✅✅ 48x! |
| ped_R | 0.145 | 0.026 | 0.067 | ✅ |
| cone_R | 0.160 | 0 | 0 | ✅ 新! |
| bg_FA | 0.331 | 0.199 | 0.222 | ⚠️⚠️ 恶化 |
| off_th | 0.169 | 0.150 | 0.174 | ⚠️ 回升 |

分析: car_P 突破停滞! 多类爆发 (bus/ped/cone).
bg_FA 恶化是多类学习早期正常现象, LR decay 后应改善.
- GPU 1 恢复正常, 训练速度 ~6.3 s/iter
- iter 6100, 下一 val: @8000 (~3/9 21:00)

---

## Cycle #199 | 2026-03-09 08:42

- iter **6380/40000** (16.0%), ~6.3-6.5 s/iter, ETA 2d 21:12
- Loss: 3.6-4.9 正常振荡, 无异常
- 无新 val (最近: @6000 car_P=0.090)
- 4 GPU 正常 (36.8-37.3 GB, 100%), 磁盘 296 GB, 22 进程
- ORCH_025 COMPLETED (测试框架), ORCH_026 COMPLETED (Plan Q: car_P=0.083, 类竞争无关)
- 下一 val: @8000 ~3/9 11:30
- **无告警**

---

## Cycle #200 | 2026-03-09 09:10

- iter **6650/40000** (16.6%), ~6.3-6.5 s/iter, ETA 2d 20:14
- Loss: 2.8-5.8 正常振荡, @6460 单点尖峰 8.01 (已回落)
- 无新 val (最近: @6000 car_P=0.090)
- 4 GPU 正常, 磁盘 296 GB, 22 进程
- 无新 ORCH, 无 PENDING
- 下一 val: @8000 ~3/9 11:30
- **无告警**
...
## Cycle #201 | 2026-03-09 09:40

- iter **6930/40000** (17.3%), ~6.3-6.5 s/iter, ETA 2d 19:17
- Loss: 2.3-6.6 正常振荡
- 无新 val, 下一 @8000 ~3/9 11:30
- 4 GPU 正常, 磁盘 296 GB, 22 进程
- **无告警**

---

## Cycle #202 | 2026-03-09 10:08

- iter **7200/40000** (18.0%), ~6.3-6.5 s/iter, ETA 2d 18:23
- Loss: 2.5-5.9 正常振荡, reg_loss 有轻微下降趋势
- 无新 val, 下一 @8000 ~3/9 11:25 (~1.4h)
- 4 GPU 正常, 磁盘 296 GB, 22 进程
- **无告警**

---

## Cycle #203 | 2026-03-09 10:38

- iter **7480/40000** (18.7%), ~6.3-6.5 s/iter, ETA 2d 17:30
- Loss 正常振荡
- 无新 val, @8000 ~3/9 11:32 (~55 min)
- 4 GPU 正常, 磁盘 296 GB, 22 进程
- **无告警**

---

## Cycle #204 | 2026-03-09 11:06

- iter **7750/40000** (19.4%), ~6.3-6.5 s/iter, ETA 2d 16:40
- Loss 正常振荡
- **@8000 val 即将开始 (~27 min)**
- 4 GPU 正常, 磁盘 296 GB, 22 进程
- **无告警**

---

## Cycle #205 | 2026-03-09 11:35

- **⏳ @8000 val 已开始!** Checkpoint 保存 11:31:19, val 30/753
- iter 8000/40000 (20.0%), ETA 2d 15:55
- Val ETA: ~12:30 出结果
- 磁盘 282 GB (ckpt 保存后正常), 进程 38 (val 启动)
- 4 GPU 正常
- **无告警**

---

## Cycle #206 | 2026-03-09 12:05

- **⏳ @8000 val 进行中**: 410/753 (54%), 结果 ETA ~12:30
- 4 GPU 正常, 磁盘 282 GB, 38 进程 (val)
- **无告警**

---

## Cycle #207 | 2026-03-09 12:33 — ⭐ @8000 Val 结果!

- iter **8020/40000** (20.1%), 训练已恢复
- **@8000 Val (DDP):**

| 指标 | @8000 | @6000 | 变化 |
|------|-------|-------|------|
| car_R | **0.718** | 0.455 | +58% ✅ |
| car_P | **0.060** | 0.090 | -33% ⚠️ |
| truck_R | 0.000 | 0.138 | 消失 ⚠️ |
| bus_R | 0.002 | 0.287 | 崩塌 ⚠️ |
| ped_R | **0.276** | 0.145 | +91% ✅ |
| cone_R | 0.000 | 0.160 | 消失 ⚠️ |
| bg_FA | **0.311** | 0.331 | -6% ✅ 回落! |
| off_th | **0.140** | 0.169 | -17% ✅ 历史最低! |

- **分析**: 类间注意力振荡 (多类→双类模式), 但结构指标 (bg_FA, offset) 持续改善
- **建议**: 继续训练, LR decay @17000 后预期稳定
- 4 GPU 正常, 磁盘 282 GB, 22 进程

---

## Cycle #208 | 2026-03-09 13:02

- iter **8300/40000** (20.8%), ~6.3-6.5 s/iter, ETA 2d 15:02
- Loss 正常振荡, post-@8000 val 巡航
- 下一 @10000 val ~3/9 16:00
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #209 | 2026-03-09 13:32

- iter **8580/40000** (21.5%), ~6.3-6.5 s/iter, ETA 2d 14:14
- Loss 正常振荡
- 下一 @10000 val ~3/9 16:00 (~2.5h)
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #210 | 2026-03-09 14:00

- iter **8850/40000** (22.1%), ~6.3-6.5 s/iter, ETA 2d 13:29
- Loss 正常振荡
- 下一 @10000 val ~3/9 16:00 (~2h)
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #211 | 2026-03-09 14:30

- iter **9130/40000** (22.8%), ~6.3-6.5 s/iter, ETA 2d 12:44
- Loss 正常振荡, @9040 单点尖峰 8.38 (已回落)
- 下一 @10000 val ~3/9 16:00 (~1.5h)
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #212 | 2026-03-09 14:58

- iter **9400/40000** (23.5%), ~6.3-6.5 s/iter, ETA 2d 12:01
- Loss 正常振荡
- 下一 @10000 val ~3/9 16:00 (~1h)
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #213 | 2026-03-09 15:28

- iter **9680/40000** (24.2%), ~6.3-6.5 s/iter, ETA 2d 11:17
- Loss 正常振荡
- **@10000 val ~34 min 后 (~16:02)**
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #214 | 2026-03-09 15:57

- iter **9960/40000** (24.9%), @10000 val ~4 min 后!
- Loss 正常振荡, ETA 2d 10:34
- 4 GPU 正常, 磁盘 282 GB, 22 进程
- **无告警**

---

## Cycle #215 | 2026-03-09 16:26

- iter **10000/40000** (25.0%), checkpoint 已保存
- @10000 val 进行中: 310/753 (41%), ETA ~16:59
- Loss@10000: 3.28 (cls=2.04, reg=1.24), grad=14.9
- 速度: ~6.28-6.52 s/iter, ETA: 2d 10:28
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警

---

## Cycle #216 | 2026-03-09 16:55

- @10000 val 进行中: **690/753** (92%), 预计 ~16:59 完成
- Loss@10000: 3.28 (cls=2.04, reg=1.24), grad=14.9
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警
...
## Cycle #217 | 2026-03-09 17:24 | ⭐ @10000 VAL CAPTURED

### @10000 Val Results (DDP)
| 类 | R | P | vs @8000 |
|------|-------|-------|---------|
| car | 0.726 | 0.069 | R↑ P↑ |
| truck | 0.239 | 0.033 | ⭐ 从 0 回归 |
| bus | 0.112 | 0.004 | ⭐ 从 0 回归 |
| CV | 0.287 | 0.002 | ⭐ 首次! |
| moto | 0.126 | 0.003 | ⭐ 首次! |
| barrier | 0.025 | 0.005 | 新增 |
| ped | 0.000 | 0.000 | ⚠️ 从 0.276 消失 |
| bg_FA | 0.407 | — | ⚠️⚠️ 历史最差 |
| off_th | 0.160 | — | ⚠️ 从 0.140 回弹 |

**分析**: 第三种注意力模式 — "车辆模式" (car+truck+bus+CV+moto), ped 消失. bg_FA 持续恶化. 类振荡无收敛, 等 LR decay @17000.

- iter 10230/40000, ETA 2d 9:54
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G
- 无 PENDING, 训练正常

---

## Cycle #218 | 2026-03-09 17:53

- iter **10510/40000** (26.3%), post-@10000 巡航
- Loss@10510: 3.16 (cls=1.52, reg=1.64), grad=3.2
- 速度: ~6.28-6.53 s/iter, ETA: 2d 9:12
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警, 等 Conductor 评估 @10000 结果

---

## Cycle #219 | 2026-03-09 18:22

- iter **10780/40000** (27.0%), 巡航正常
- Loss@10780: 7.19 (cls=4.61, reg=2.58), grad=17.6
- 注: @10660 loss=9.13 单次尖峰, 已恢复
- 速度: ~6.28-6.52 s/iter, ETA: 2d 8:33
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警

---

## Cycle #220 | 2026-03-09 18:51

- iter **11060/40000** (27.7%), 巡航正常
- Loss@11060: 0.64 (纯背景 batch), @11040: 3.90 (正常)
- 速度: ~6.28-6.52 s/iter, ETA: 2d 7:52
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警. @12000 val 约 1.5h 后

---

## Cycle #221 | 2026-03-09 19:20

- iter **11330/40000** (28.3%), 巡航正常
- Loss@11330: 3.69 (cls=2.79, reg=0.91), grad=41.7
- 速度: ~6.27-6.53 s/iter, ETA: 2d 7:14
- GPU 0-3: 93-100% (正常), 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警. @12000 val 约 1h 后

---

## Cycle #222 | 2026-03-09 19:49

- iter **11610/40000** (29.0%), 巡航正常
- Loss@11610: 1.93 (cls=0.84, reg=1.09), grad=17.3
- 速度: ~6.28-6.55 s/iter, ETA: 2d 6:34
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警. @12000 val 约 40 min 后

---

## Cycle #223 | 2026-03-09 20:18

- iter **11880/40000** (29.7%), @12000 约 13 min 后触发
- Loss@11880: 0.27 (纯背景 batch), @11870: 4.22 (正常)
- 观察: 纯背景 batch 频率升高 (4/15 iters), 非异常
- 速度: ~6.28-6.54 s/iter, ETA: 2d 5:57
- GPU 0-3: 100%, 36.8-37.3 GB | 磁盘: 267G (93%)
- 无 PENDING, 无告警

---

## Cycle #224 | 2026-03-09 20:47

- iter **12000/40000** (30.0%), checkpoint 已保存
- @12000 val 进行中: 240/753 (32%), 速度 ~4.07 s/batch, 预计 ~21:22 完成
- 磁盘: 253G (checkpoint 占 ~14G)
- GPU 0-3: 85-100% (val), 36.8-37.3 GB | 38 进程
- 无 PENDING, 无告警

---

## Cycle #225 | 2026-03-09 21:17

- @12000 val 进行中: **670/753** (89%), 预计 ~21:22 完成
- GPU 0-3: 95-100% (val) | 磁盘: 253G (93%)
- 无 PENDING, 无告警

---

## Cycle #226 | 2026-03-09 21:33 | ⭐ @12000 VAL CAPTURED

### @12000 Val Results (DDP)
| 类 | R | P | vs @10000 |
|------|-------|-------|---------|
| car | 0.526 | **0.081** | R↓ P↑ (更精准) |
| bus | **0.222** | 0.011 | ↑ |
| 其他 | 0.000 | 0.000 | 全部消失 |
| bg_FA | **0.278** | — | ✅✅ 从 0.407 大幅恢复! |
| off_th | **0.128** | — | ✅✅✅ 历史最佳! |
| off_cx | **0.038** | — | ✅✅ 历史最佳! |

**分析**: 第4种模式 "精准双类" (car+bus). 活跃类少但质量最高. 底层表征持续突破, off_th 从未停止改善. bg_FA 与活跃类数量反相关.

- iter 12100/40000, ETA 2d 5:27
- GPU 0-3: 100%, 36.4-37.0 GB | 磁盘: 253G
- 无 PENDING

---

## Cycle #227 | 2026-03-09 21:33

- iter **12100/40000** (30.3%), post-@12000 训练刚恢复
- Loss@12100: 4.61 (cls=2.43, reg=2.18), grad=22.7
- GPU 0-3: 92-100%, 36.4-37.0 GB | 磁盘: 253G (93%)
- 无 PENDING, 无告警
# Supervisor 摘要报告
...
---
### Cycle #238 | 2026-03-11 21:31 | ORCH_029 @1640 | loss=4.18 cls=2.13 reg=2.05 | reg0=7.3% | GPU ✅ | Disk 93% | LR=2.05e-6

---
### Cycle #239 | 2026-03-11 22:00 | ORCH_029 @1910 | loss=4.87 cls=2.89 reg=1.98 | reg0=9.4% (cluster@1700-1760) | GPU ✅ | Disk 93% | LR=2.39e-6 | ⭐@2000 val in ~10min

---
### Cycle #240 | 2026-03-11 22:28 | ⭐ ORCH_029 @2000 WARMUP DONE | ckpt saved | val IN PROGRESS 220/753 | loss=4.93 cls=3.03 reg=1.90 | reg0=9.0% | LR=2.5e-6 | Disk 94% (239GB)

---
### Cycle #241 | 2026-03-11 22:57 | ORCH_029 @2000 val 550/753 (73%) ETA ~23:15 | GPU ✅ | Disk 94%

---
### Cycle #242 | 2026-03-11 23:26 | ⭐⭐⭐ ORCH_029 @2000 VAL RESULTS
- **car_P=0.0514** (ORCH_024: 0.079, ⚠️ -35%)
- **bg_FA=0.1615** (ORCH_024: 0.222, ✅ -27% 大幅改善!)
...
---
### Cycle #245 | 2026-03-12 00:53 | ORCH_032 @740/40000 | loss=9.76(spike) cls=7.66 reg=2.11 | reg0=8.1% (cluster@620-660) | GPU ✅ | Disk 94%

---
### Cycle #246 | 2026-03-12 01:22 | ORCH_032 @1020/40000 | loss=8.02 cls=5.24 reg=2.78 | reg0=7.8% | LR=1.28e-6 (51% warmup) | GPU ✅ | Disk 94%

---
### Cycle #247 | 2026-03-12 01:51 | ORCH_032 @1290/40000 | loss=5.69 cls=3.38 reg=2.31 | reg0=7.8% | LR=1.61e-6 (64% warmup) | grad_norm high (50-133) | GPU ✅ | Disk 94%

---
### Cycle #248 | 2026-03-12 02:21 | ORCH_032 @1570/40000 | loss=6.29 cls=4.03 reg=2.25 | reg0=7.0% | LR=1.96e-6 (78% warmup) | GPU ✅ | Disk 94%

---
### Cycle #249 | 2026-03-12 02:49 | ORCH_032 @1840/40000 | loss=5.84 cls=3.40 reg=2.45 | reg0=9.8% (cluster@1700-1760 same as ORCH_029!) | LR=2.30e-6 (92% warmup) | GPU ✅ | Disk 94%

---
### Cycle #250 | 2026-03-12 03:19 | ⭐ ORCH_032 @2000 WARMUP DONE | ckpt saved | val IN PROGRESS 180/753 (24%) ETA ~03:58 | train_loss=6.14 | reg0=9.0% | val_speed=4.08s (22% faster) | Disk 224GB

---
### Cycle #251 | 2026-03-12 03:48 | ORCH_032 @2000 val 600/753 (80%) ETA ~03:58 | GPU ✅ | Disk 94% (224GB)
...
---
### Cycle #255 | 2026-03-12 05:50 | ⭐ ORCH_032→033→034 SWITCH | ORCH_034 @200/40000 (multilayer_v3, warm start from ORCH_029@2000) | BUG-52/57/58/59/60 all fixed | loss=3.5-7.1 STABLE | reg=0 NEVER | grad_norm~28 | VRAM 30.6GB | GPU ✅ | Disk 94%

---
### Cycle #256 | 2026-03-12 06:15 | ORCH_034 @460/40000 | loss=3.5-6.5 STABLE | reg0=2/46 (4.3% DDP normal) | grad_norm~34 | warmup 23% | GPU ✅ | Disk 94%

---
### Cycle #257 | 2026-03-12 06:45 | ORCH_034 @740/40000 | loss=3.2-8.6 | reg0 cluster @580-660 (4/29=13.8%, data segment) | grad_norm~35 | warmup 37% | GPU ✅ | Disk 94%

---
### Cycle #258 | 2026-03-12 07:15 | ORCH_034 @1010/40000 | loss trending down (2.9-6.2) | cls~2.5 | reg0=8% (data segments) | warmup 50% | grad_norm~35 | GPU ✅ | Disk 94%

---
### Cycle #259 | 2026-03-12 07:45 | ORCH_034 @1290/40000 | loss floor dropping (1.87-2.03 new lows) | reg0=6.9% | warmup 64.5% | @2000 val ETA ~09:00 | GPU ✅ | Disk 94%

---
### Cycle #260 | 2026-03-12 08:15 | ORCH_034 @1560/40000 | loss new low 2.22 (cls=0.61!) | reg0=3.8% | grad_norm spike 143.6 (single, recovered) | warmup 78% | @2000 val ETA ~08:55 | GPU ✅ | Disk 94%

---
### Cycle #261 | 2026-03-12 08:40 | ORCH_034 @1830/40000 | reg0 CLUSTER @1700-1760 (6x, 3rd confirmation across experiments!) | warmup 91.5% | @2000 val ETA ~08:55 | post-cluster loss normal 2.6-5.4 | GPU ✅ | Disk 94%
---
### Cycle #262 | 2026-03-12 09:09 | ⭐ ORCH_034 @2000 WARMUP_COMPLETE | LR=2.5e-6 locked | val IN PROGRESS 190/753 (25%) ETA ~09:47 | loss@2000=5.11 reg=1.91 healthy | Disk 95% (209GB) | GPU ✅

---
### Cycle #263 | 2026-03-12 09:37 | ORCH_034 @2000 val 590/753 (78.4%) ETA ~09:47 | val stable ~4.1s/iter no errors | GPU ✅ | Disk 95% (209GB)

---
### Cycle #264 | 2026-03-12 10:05 | ⭐⭐ ORCH_034 @2000 VAL COMPLETE | car_R=0.8124 (2.17x ORCH_029!) | bg_FA=0.2073 ✅ | off_th=0.1655 ✅ | ped_R=0 ⚠️ (all non-car=0) | post-val training healthy @2160 | GPU 37GB 100% | Disk 95%

---
### Cycle #265 | 2026-03-12 10:35 | ORCH_034 @2440/40000 | post-val training healthy | loss spike @2380 (10.36, recovered) | reg0 @2410 (single) | avg loss ~4.8 | next val @4000 ETA ~22:20 | GPU 37GB 100% | Disk 95%

---
### Cycle #266 | 2026-03-12 11:03 | ORCH_034 @2710/40000 | stable cruise | reg0 @2450 (single) | loss avg ~4.9 | Conductor: continue to @4000 | next val @4000 ETA ~22:00 | GPU 37GB 100% | Disk 95%
...
---
### Cycle #269 | 2026-03-12 12:30 | ORCH_034 @3530/40000 | loss avg ~4.3 (slight decrease) | reg0 @3270,@3520 (sporadic) | @4000 val ETA ~21:00 | GPU 37GB 100% | Disk 95%

---
### Cycle #270 | 2026-03-12 12:58 | ORCH_034 @3800/40000 | reg0 @3660 (single) | 2x loss>10 spikes (@3670,@3770, both recovered) | loss avg ~4.2 | approaching @4000 (~22min) | GPU 37GB 100% | Disk 95%
...
---
### Cycle #273 | 2026-03-12 14:26 | ⭐⭐ ORCH_034 @4000 VAL COMPLETE (Rule #6) | car_R=0.8195 ✅ | 4 NEW classes activated: bus=0.070 cv=0.110 ped=0.024 cone=0.130 | ⚠️ bg_FA=0.3240 RED LINE BREACH (was 0.2073) | off_th=0.1598 ✅ | bg_R=0.6760↓ | post-val @4070 healthy | GPU 37GB 100% | Disk 95% (194GB)

---
### Cycle #274 | 2026-03-12 14:56 | ORCH_034 @4350/40000 | post-@4000 val training very healthy | zero reg0 (28 iters) | loss avg ~4.5 | Conductor submitted @4000 val to Critic | awaiting decision | GPU 37GB 100% | Disk 95% (194GB)
...
---
### Cycle #279 | 2026-03-12 19:45 | ORCH_035 @5020/40000 ⭐ 5000 milestone | loss avg ~4.4 stable | 2x reg0 @4760,4800 | grad_norm spike 78.7@4790 (single, recovered) | GPU 39.5GB 100% | Disk SSD 95% /home 99% (68GB↓)

---
### Cycle #280 | 2026-03-12 20:14 | ORCH_035 @5300/40000 | loss avg ~4.3 stable | spike 8.74@5280 (single, recovered) | 2x reg0 @5050,5130 | grad_norm 52.6 max | GPU 39.5GB 100% | Disk SSD 95% /home 99%

---
### Cycle #281 | 2026-03-12 20:43 | ORCH_035 @5570/40000 | very clean window | loss avg ~4.2 (improving) | 1x reg0@5520 | no spikes | grad_norm stable 13-46 | GPU 39.5GB 100% | Disk SSD 95% /home 99%
...
---
### Cycle #285 | 2026-03-12 22:39 | ⭐⭐ ORCH_035 @6000 VAL RESULTS | bg_FA=0.0938 ✅✅ (was 0.3240 RED LINE!) | 🔴 car_R=0.2329 (-71.6% from 0.8195) | 🔴 off_th=0.2848 RED LINE | cv_R=0.2581 ✅ (+136%) | most classes=0 | model needs more iter to adapt? | post-val @6170 normal | GPU 37.8GB 100%

---
### Cycle #286 | 2026-03-12 23:08 | ORCH_035 @6440/40000 post-val | spike 9.87@6310 (highest, recovered) | zero reg0 | loss avg ~4.6 | reg stabilizing ~1.7 | GPU 37.8GB 100% | Disk SSD 96% /home 99%

---
### Cycle #287 | 2026-03-12 23:37 | ORCH_035 @6720/40000 | clean window | loss avg ~4.5 | 1x reg0@6450 | no spikes | ~1280 iter to @8000 (~2.3h) | GPU 37.8GB 100% | Disk SSD 96% /home 99%

---
### Cycle #288 | 2026-03-13 00:06 | ORCH_035 @6990/40000 | loss avg ~4.3 | 2x reg0@6860-6870 (pair) | post-reg0 spike 7.59 (typical) | ~1010 iter to @8000 (~1.8h) | GPU 37.8GB 98-100% | Disk SSD 96% /home 99%

---
### Cycle #289 | 2026-03-13 00:36 | ORCH_035 @7270/40000 ⭐ 7000 milestone | very clean window | loss avg ~4.4 | 1x reg0@7270 | no spikes | grad_norm low ~18 avg | @8000 in ~1.3h (~01:55) | GPU 37.8GB 100% | Disk SSD 96% /home 99%

- **Cycle #290** (01:06) | ORCH_035 @7540/40000 (18.9%) | loss ~4.3 | 1x reg=0 @7520 | @8000 ETA ~01:53 ⏰ | GPU 4x100% | 磁盘 SSD=96% home=99%⚠️ | 0 PENDING

- **Cycle #291** (01:34) | ORCH_035 @7810/40000 (19.5%) | loss ~4.5 | 1x reg=0 @7660 | ⏰ @8000 ETA ~01:53 (~20min!) | GPU 4x100% | 磁盘 SSD=96% home=99%⚠️ | 0 PENDING

- **Cycle #292** (02:03) ⭐ | ORCH_035 **@8000 CHECKPOINT SAVED** 01:52:55 | Val 进行中 110/753 (14.6%) ETA~02:52 | loss~4.1 | 4x reg=0 cluster @7870-7990 | GPU 4x97-100% | SSD=163GB(↓15GB ckpt) home=68GB⚠️ | Rule #6!
...
- **Cycle #296** (03:58) | ORCH_035 @8620/40000 (21.6%) | loss ~4.4 | 0 reg=0 | 0 spike | 极干净窗口 | GPU 4x100% | SSD=163GB home=68GB⚠️ | 0 PENDING

- **Cycle #297** (04:28) | ORCH_035 @8900/40000 (22.3%) | loss ~4.1 ↓ | 0 reg=0 | 0 spike | 极干净 | GPU 4x100% | SSD=163GB home=68GB⚠️ | @10000 ETA~06:28 | 0 PENDING

- **Cycle #298** (04:57) | ORCH_035 @9170/40000 (22.9%) | loss ~3.9 ↓↓ | 0 reg=0 | 0 spike | 极干净 x2 | GPU 4x100% | SSD=163GB home=68GB⚠️ | @10000 ETA~06:26 | 0 PENDING

- **Cycle #299** (05:26) | CEO_CMD 已处理→report written | ORCH_035 @9450/40000 (23.6%) | loss ~3.9 | 0 reg=0 | clean x3 | @10000 ETA~06:25 | 0 PENDING
# Supervisor 摘要报告
...
- Conductor idle, 重复 health verdict 已归档 (#4)
- 系统 idle，等待 CEO 决策 BUG-75/84/85
...
# Supervisor 摘要报告
> 时间: 2026-03-16 19:22:08

## 训练状态
- **无训练运行**。GPU 0,2 空闲; 1,3 yl0826 (100%)
- 无新 GiT commit (最新 c875db3)
- Conductor idle cycle #5, 系统等待 CEO 决策 BUG-75/84/85
