# Critic 审计指令 — CEO_ARCH_QUESTIONS
...
## 3. 读取审计请求
读取 shared/audit/requests/AUDIT_REQUEST_CEO_ARCH_QUESTIONS.md
...
## 6. 调试验证（如需）
调试脚本写入：/home/UNT/yz0370/projects/GiT/ssd_workspace/Debug/Debug_20260308/
文件名必须以 debug_ 前缀

## 7. 写入判决
写入 shared/audit/pending/VERDICT_CEO_ARCH_QUESTIONS.md
判决必须包含：结论(PROCEED/STOP/CONDITIONAL)、发现的问题(附文件路径+行号)、对 Conductor 计划的评价

## 8. 提交
cd /home/UNT/yz0370/projects/GiT_agent
git add shared/audit/pending/ && git commit -m "critic: verdict CEO_ARCH_QUESTIONS" && git push
