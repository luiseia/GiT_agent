...
## 3. 读取审计请求
读取 shared/audit/requests/AUDIT_REQUEST_ORCH059_LOSS_INIT.md
...
## 7. 调试验证（如需）
调试脚本写入：/home/UNT/yz0370/projects/GiT/ssd_workspace/Debug/Debug_20260316/
文件名必须以 debug_ 前缀

## 8. 写入判决
写入 shared/audit/pending/VERDICT_ORCH059_LOSS_INIT.md
判决必须包含以下所有部分：
...
git add shared/audit/pending/ && git commit -m "critic: verdict ORCH059_LOSS_INIT" && git push
