...
## 3. 读取审计请求
读取 shared/audit/requests/AUDIT_REQUEST_ORCH035_AT12000.md
...
## 6. 调试验证（如需）
调试脚本写入：/home/UNT/yz0370/projects/GiT/ssd_workspace/Debug/Debug_20260313/
文件名必须以 debug_ 前缀

## 7. 写入判决
写入 shared/audit/pending/VERDICT_ORCH035_AT12000.md
判决必须包含：结论(PROCEED/STOP/CONDITIONAL)、发现的问题(附文件路径+行号)、对 Conductor 计划的评价

## 8. 提交
cd /home/UNT/yz0370/projects/GiT_agent
git add shared/audit/pending/ && git commit -m "critic: verdict ORCH035_AT12000" && git push
