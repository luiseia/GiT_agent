...
## 3. 读取审计请求
读取 shared/audit/requests/AUDIT_REQUEST_12000_TERMINATE.md
...
## 7. 写入判决
写入 shared/audit/pending/VERDICT_12000_TERMINATE.md
判决必须包含：结论(PROCEED/STOP/CONDITIONAL)、发现的问题(附文件路径+行号)、对 Conductor 计划的评价

## 8. 提交
cd /home/UNT/yz0370/projects/GiT_agent
git add shared/audit/pending/ && git commit -m "critic: verdict 12000_TERMINATE" && git push
